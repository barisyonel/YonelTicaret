      ...
      <section className="py-16 md:py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto text-center">
            {/* Main Heading - H1 for SEO - OPTIMIZED */}
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-primary mb-6 leading-tight">
              Yedek Parça | İveco Daily, Fiat Ducato, Foton ve Karataş Traktör
            </h1>
            
            {/* H2 Subtitle - SEO Structure */}
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 mb-6 leading-tight">
              Türkiye'nin En Güvenilir Oto Yedek Parça Tedarikçisi - 50+ Yıllık Tecrübe
            </h2>
            
            {/* Description */}
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-5xl mx-auto font-medium mb-6">
              <strong>Yönel Oto Yedek Parça</strong> olarak İveco Daily yedek parçaları, Fiat Ducato yedek parça, 
              Foton traktör yedek parçaları, Karataş traktör yedek parçaları ve Mutlu akü satışında 
              Türkiye'nin en güvenilir adresi olmaktan gurur duyuyoruz. Orijinal yedek parça garantisi, 
              hızlı teslimat ve uzman kadromuzla hizmetinizdeyiz.
            </p>
            
            {/* Additional SEO Content */}
            <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-4xl mx-auto">
              Tokat merkezli firmamız, 1970 yılından bu yana oto yedek parça sektöründe faaliyet göstermekte 
              ve Türkiye'nin 81 iline hızlı kargo ile orijinal yedek parça, yan sanayi yedek parça ve 
              kaliteli muadil parça hizmeti sunmaktadır. İveco Daily 120-14, İveco Daily 85-12, İveco Daily 65-9, 
              Fiat Ducato 2.3, Fiat Ducato 3.0, Foton traktör ve Karataş traktör yedek parçaları stoklarımızda mevcuttur.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">
              Yedek Parça Markaları - İveco, Ducato, Foton, Karataş
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-4">
              İveco Daily (120-14, 85-12, 65-9, 50NC), Fiat Ducato, Foton Traktör, Karataş Traktör ve Mutlu Akü ürünlerinin 
              tüm orijinal yedek parçalarını bulabilirsiniz. Firmamız, oto yedek parça sektöründe Türkiye'nin önde gelen 
              tedarikçilerinden biridir ve yedek parça ihtiyaçlarınız için geniş ürün yelpazesi sunmaktadır.
            </p>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Traktör yedek parçaları, ticari araç yedek parçaları, hafif ticari yedek parça ve akü çeşitlerimizle 
              araçlarınızın bakım ve onarım ihtiyaçlarını karşılıyoruz. Orijinal yedek parça kalitesi, uygun fiyat 
              politikamız ve hızlı teslimat garantimizle yanınızdayız.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-12 bg-white rounded-2xl shadow-lg p-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b-4 border-primary pb-4">
                İveco Daily Yedek Parça - Orijinal ve Muadil Parçalar
              </h2>
              <div className="prose prose-lg max-w-none">
                ...
                <p className="text-gray-700 leading-relaxed">
                  İveco Daily yedek parçaları hakkında daha fazla bilgi için{' '}
                  <a 
                    href="https://www.iveco.com/tur/Pages/homepage.aspx" 
                    target="_blank" 
                    rel="noopener noreferrer nofollow"
                    className="text-primary font-semibold hover:underline"
                  >
                    İveco resmi web sitesini
                  </a>
                  {' '}ziyaret edebilir veya firmamızla iletişime geçebilirsiniz.
                  Hafif ticari araç yedek parçaları konusunda uzman kadromuz, İveco Daily yedek parça 
                  ihtiyaçlarınızı en hızlı ve güvenilir şekilde karşılamaktadır.
                </p>
              </div>
            </div>
            ...
            <div className="mb-12 bg-white rounded-2xl shadow-lg p-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b-4 border-primary pb-4">
                Fiat Ducato Yedek Parça - Ticari Araç Parçaları
              </h2>
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <div className="mb-12 bg-white rounded-2xl shadow-lg p-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b-4 border-primary pb-4">
                Foton Traktör Yedek Parça - Tarım Makinası Parçaları
              </h2>
              <div className="prose prose-lg max-w-none">
